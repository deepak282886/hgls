...
Fixed: compute_reward() no longer modifies structure.fitness.
Tester already set fitness from score. Reward system handles
intrinsic signals and propagation only.
"""
...
TOKEN_REWARD_AMOUNT  = 0.02
TOKEN_PENALTY_AMOUNT = 0.02
CHILD_DECAY          = 0.5
...
class InternalRewardSystem:
    ...
    def compute_reward(
        ...
        """
        Compute intrinsic reward. Does NOT modify structure.fitness —
        the tester already set that from the reconstruction score.
        Returns reward value for logging only.
        """
